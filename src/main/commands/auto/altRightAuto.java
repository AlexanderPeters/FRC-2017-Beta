...
public class altRightAuto extends CommandGroup implements Constants {
	public altRightAuto() {
		addSequential(new DriveDistance(1.51, kToleranceDisplacementDefault, false));
		//addSequential(new DriveDistance(1, kToleranceDisplacementDefault));
		addSequential(new TurnToAngle(-45, 0.5, false));//Better turning tolerance
		addSequential(new DriveDistance(8.68, kToleranceDisplacementDefault, false));
